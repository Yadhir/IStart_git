...
<div id="page" class="container-fluid">
    ...
    <div id="page-content" class="row-fluid">
                <section id="region-main" class="<?php if ($left) { echo ' pull-right'; } ?>">
                    ...
                    echo '<div class="inv">'.$OUTPUT->main_content().'</div>';
                    echo '<div id="box_block_float">'.$OUTPUT->blocks('side-post').'</div>';
                    echo $OUTPUT->course_content_footer();
                    ?>
                </section>

                <section  id="region-center" style="position: absolute;
                                top: 69%;
                                left: 50%;
                                width: 821px;
                                margin-left: -379px;
                                ...
                                padding: 5px;">
                    <?php
                    echo $OUTPUT->blocks('side-pre2', ''.$classextra);                    
                    ?>
                </section>
